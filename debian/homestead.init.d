...
do_start()
{
        ...
        setup_environment
        get_daemon_args
        $namespace_prefix start-stop-daemon --start --quiet --background --make-pidfile --pidfile $PIDFILE --exec $DAEMON --chuid $NAME --chdir $HOME -- $DAEMON_ARGS --scheme-unknown=SIP\ Digest \
                || return 2
